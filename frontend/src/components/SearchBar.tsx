    ...
    <form onSubmit={handleSubmit} className="relative w-full max-w-2xl mx-auto">
      <div className="relative">
        <input
          ...
          className="w-full pl-12 pr-12 py-3.5 bg-white border border-orange-100 rounded-2xl shadow-sm text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 placeholder-stone-400 text-stone-800 transition-all font-sans"
        />
